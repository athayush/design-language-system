...
const meta: Meta<typeof MedicalCase> = {
  title: "athcare/atoms/MedicalCase",
  component: MedicalCase,
  tags: ["autodocs"],
  argTypes: {
    idx: {
      control: { type: "number" },
      description: "Index of the case in the timeline",
    },
    mediCase: {
      description: "Medical case data (PGAthCareCase)",
    },
  },
};
...
type Story = StoryObj<typeof MedicalCase>;

const mockCase: PGAthCareCase =   {
