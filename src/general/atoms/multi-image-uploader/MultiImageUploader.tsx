...
type MultiImageUploaderProps = {
  ...
  maxFiles?: number;
  maxSizeMB?: number;
  handleFilesAdded: (addedFiles: FileWithPreview[]) => void;
  className?: {
    dropArea?: string;
  };
};

export function MultiImageUploader({ initialFiles, accepts = "image/*", maxFiles = 6, maxSizeMB = 5, handleFilesAdded, className }: MultiImageUploaderProps) {
  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      <div
        ...
        className={cn("border-input data-[dragging=true]:bg-accent/50 has-[input:focus]:border-ring has-[input:focus]:ring-ring/50 relative flex min-h-52 flex-col items-center overflow-hidden rounded-xl border border-dashed p-4 transition-colors not-data-[files]:justify-center has-[input:focus]:ring-[3px]", className?.dropArea)}
      >
        <input
          {...getInputProps()}
          className="sr-only"
